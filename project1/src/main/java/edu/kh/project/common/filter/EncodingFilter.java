...
//@webFilter 어노테이션 : 필터링을 지정할 요청 주소를 작성하는 어노테이션임....
//						 + 필터로 등록하는 것까지 
...
public class EncodingFilter extends HttpFilter implements Filter {
	 ...
	 * 알맞은 Servlet으로 전달이 된다.
	 * 그 전달되기 전에 특정 코드를 수행하는 클래스임....
	 * 
	 * 클라이언트 -> 요청 -> HttpServletRequest    -> 필터  -> 알맞은 Servlet
	 * 						 HttpServletResponse
	 * 						 객체 생성
	 * 
	 * - 여러 필터를 만들어 연쇄적으로 수행 가능함. (FilterChain)
	 * 
	 * - 만약, 필터 순서를 지정하고자 하면, 
	 *  web.xml 파일에 필터의 이름을 순서대로 작성하면 됨......
	 * */
