...
<body>
    ...
    <%
        ...
        // 추가 세팅된 값 얻어오기 (다운캐스팅이 필요함./객체는 import도 필요함)
    ...
    <h4>\${값 !== null }, \${ 값 ne null } : null인지 검사하는 방법</h4>
