...
public class ServletEx2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 전달된 input 태그의 값(파라미터) 얻어와서 변수에 저장하겠다!!!! (파라미터는 무조건 String임)
		
		String orderer = req.getParameter("orderer");
		
		// radio버튼은 값 1개만 선택 가능하니까, 값1개만 서버로 제출됨 그니까 type으로 써도 하나만 제출되는 거임
		String type = req.getParameter("type");
		
		// select박스는 1개의 option만 선택이 가능하기 때문에, 값1개만 서버로 제출된다.
		...
		//  							단, 값이 하나도 없으면 null(null : 참조하는 객체가 없다는 뜻)
		...
		// 선택한 옵션(ul, 옵션이 있을 경우만 이 화면을 만들어서 보여주겠다.)
		// - 1샷 추가
		// - 2샷 추가
		// - 연하게
		...
		//(HTML, CSS, JS 등 브라우저가 해석할 수 있는 코드는 모두 해석돼서 보여짐.)
...
//				}
				...
				switch(s) {
				case "shot1" : s=  "1샷추가"; break;
				case "shot2" : s=  "2샷추가"; break;
				case "softly" : s=  "연하게"; break;
				}
