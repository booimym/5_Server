...
//		out.println("</html>");
		...
		// views 폴더 내부에 존재하는 loginResult.jsp 파일을 선택
		...
		// 왜그럴깡? JSP가 요청 데이터(req)를 이용해서 화면을 만들고
		...
		req.setAttribute("r", result);  //result는 string임. Object자리에 들어와도 문제 없다.
										//다형성때문에!(하나의 객체가 참조변수에 따라 다양한 모양이 될 수 있다) 
										//result가 String이 될 수도 있고, object가 될 수도 있고(upcasting)
										//object로 upcasting된 상태임.
